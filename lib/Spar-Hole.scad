...
module CreateSparHole_2()
{
    translate([ 0, spar_hole_offset_2, 0 ]) union()
    {
        translate([ spar_hole_perc_2 / 100 * wing_root_chord_mm, 0, 0 ]) difference()
        {
            translate([ 0, spar_hole_size_2 / 2 - (slice_gap_width/2), 0 ]) cube([ slice_gap_width, 50, spar_hole_length_2 + 10 ]);

            translate([ -5, spar_hole_size_2 / 2, spar_hole_length_2 ]) rotate([ 35, 0, 0 ]) cube([ 10, 50, 20 ]);
        }
